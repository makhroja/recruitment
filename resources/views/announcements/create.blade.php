...
@section('content')
    <div>
        <h4 class="mb-3 mb-md-0">Buat Pengumuman</h4>
    </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('announcements.store') }}" accept-charset="UTF-8"
                        id="create_announcement_form" name="create_announcement_form" class="form-horizontal"
