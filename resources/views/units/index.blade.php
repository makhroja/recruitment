...
@section('content')
    <div>
        <h4 class="mb-3 mb-md-0">Unit Lists</h4>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <a href="{{ route('units.create') }}" class="btn btn-ico btn-success" title="Create New User">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            table.on('click', '.edit', function() {
                ...
                var url = "{{ url('/units') }}" + '/' + uuid + '/edit/';
                window.open(url, "_self")
            });

            table.on('click', '.show', function() {
                var uuid = $(this).data("id");
                var url = "{{ url('/units') }}" + '/' + '' + uuid;
                window.open(url, "_self")
            });
