...
@section('content')
    <div>
        <h4 class="mb-3 mb-md-0">Unit Create</h4>
    </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('units.store') }}" accept-charset="UTF-8" id="create_unit_form"
                        name="create_unit_form" class="form-horizontal"[% upload_files %]>
                        {{ csrf_field() }}
