...
@section('content')
    <div>
        <h4 class="mb-3 mb-md-0">Position Lists</h4>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <a href="{{ route('positions.create') }}" class="btn btn-ico btn-success" title="Create New User">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                // select: true,
                // select: 'single',
                ajax: "{{ url('/positions/getPositionJson') }}",
                order: [
                    [1, 'asc']
                ],
                columnDefs: [{
            ...
            table.on('click', '.edit', function() {
                ...
                var url = "{{ url('/positions') }}" + '/' + uuid + '/edit/';
