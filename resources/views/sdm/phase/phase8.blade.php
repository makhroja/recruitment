            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title mb-2">Data Tes Kesehatan Calon Karyawan RSU HI</h6>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            table.on('change', '.status', function() {
                ...
                if (status == 1) {
                    var message = "Lolos Tes Kesehatan.?";
                }
                if (status == 2) {
                    var message = "Tidak Lolos Tes Kesehatan.?";
                }
                swal({
                    title: 'Anda Yakin?',
                    text: name + message,
            ...
            $("#jobSelect").on("click", function() {
                ...
                if (uuid == null) {
                    ...
                    var url = "{{ url('/getPhase8Json') }}" + '/' + uuid;
