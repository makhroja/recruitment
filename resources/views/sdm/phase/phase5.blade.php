            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title mb-2">Data Tes Wawancara HRD Calon Karyawan RSU HI</h6>
                            ...
                            <table id="dataTable" style="width:100%"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nama Lengkap</th>
                                        <th>Nilai</th>
                                        <th colspan="2" class="text-center">Wawancara HRD</th>
                                        <th>Lamaran</th>
                                    </tr>
                                    <tr>
                                        <th></th>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            table.on('change', '.status', function() {
                ...
                if (status == 1) {
                    var message = "Lolos Tes Wawancara HRD.?";
                }
                if (status == 2) {
                    var message = "Tidak Lolos Tes Wawancara HRD.?";
                }
                swal({
                    title: 'Anda Yakin?',
                    text: name + message,
            ...
            $("#jobSelect").on("click", function() {
                ...
                if (uuid == null) {
                    ...
                    var url = "{{ url('/getPhase5Json') }}" + '/' + uuid;
