    ...
    <div class="col-md-10">
        <select class="form-control select2 @error('job_id') is-invalid @enderror" id="job_id" name="job_id">
            <option value="" style="display: none;"
                {{ old('job_id', optional($jobDetail)->job_id ?: '') == '' ? 'selected' : '' }} disabled selected>Pilih
                job</option>
...
<div class="form-group {{ $errors->has('unit_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <select class="form-control select2 @error('unit_id') is-invalid @enderror" id="unit_id" name="unit_id">
            <option value="" style="display: none;"
                {{ old('unit_id', optional($jobDetail)->unit_id ?: '') == '' ? 'selected' : '' }} disabled selected>
                Pilih unit</option>
...
<div class="form-group {{ $errors->has('position_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <select class="form-control select2 @error('position_id') is-invalid @enderror" id="position_id"
            name="position_id">
            <option value="" style="display: none;"
                {{ old('position_id', optional($jobDetail)->position_id ?: '') == '' ? 'selected' : '' }} disabled
...
<div class="form-group {{ $errors->has('pendidikan') ? 'has-error' : '' }}">
    ...
    <div class="col-md-6">
        <select required class="form-control select2" id="pendidikan" name="pendidikan">
            <option value="" style="display: none;"
                {{ old('pendidikan', optional($jobDetail)->pendidikan ?: '') == '' ? 'selected' : '' }} disabled
                selected>
...
<div class="form-group {{ $errors->has('jurusan') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control  @error('jurusan') is-invalid @enderror" name="jurusan" type="text" id="jurusan"
            value="{{ old('jurusan', optional($jobDetail)->jurusan) }}" minlength="1"
...
<div class="form-group {{ $errors->has('jk') ? 'has-error' : '' }}">
    ...
    <div class="col-md-6">
        <select required class="form-control select2 @error('jk') is-invalid @enderror" id="jk" name="jk">
            <option value="" style="display: none;"
...
<div class="form-group {{ $errors->has('umur') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control  @error('umur') is-invalid @enderror" name="umur" type="text" id="umur"
            value="{{ old('umur', optional($jobDetail)->umur) }}" minlength="1" placeholder="Isikan umur disini...">
...
<div class="form-group {{ $errors->has('jumlah') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control  @error('jumlah') is-invalid @enderror" name="jumlah" type="text" id="jumlah"
            value="{{ old('jumlah', optional($jobDetail)->jumlah) }}" minlength="1"
