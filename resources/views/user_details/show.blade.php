                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    @else
                                        <img src="{{ url('assets/uploads/foto') }}/{{ $userDetail->foto }}" alt=""
                                            srcset="" style="border: 5px solid #7987A1;" width="200px" height="300px">
                                    @endif
                                </div>
                                <div class="col-md-9">
                                    <table class="table table-bordered">
                                        ...
                                        <tr height="30px !important;">
                                            ...
                                            <td> {{ $userDetail->agama == '' ? 'belum diisi' : $userDetail->agama }}
                                            </td>
                                        </tr>
                                        <tr height="30px !important;">
                                            <td class="bg-secondary text-white">Alamat KTP</td>
                                            <td> {{ $userDetail->alamat_ktp == '' ? 'belum diisi' : $userDetail->alamat_ktp }}
                                            </td>
                                        </tr>
                                        <tr height="30px !important;">
                                        ...
                                        <tr height="30px !important;">
                                            ...
                                            <td> {{ $userDetail->no_hp == '' ? 'belum diisi' : $userDetail->no_hp }}
                                            </td>
                                        </tr>
                                        <tr height="30px !important;">
                                        ...
                                        <tr height="30px !important;">
                                            ...
                                            <td> {{ $userDetail->pendidikan == '' ? 'belum diisi' : $userDetail->pendidikan }}
                                            </td>
                                        </tr>
                                        <tr height="30px !important;">
                                            <td class="bg-secondary text-white">Nama Sekolah / Universitas</td>
                                            <td> {{ $userDetail->instansi == '' ? 'belum diisi' : $userDetail->instansi }}
                                            </td>
                                        </tr>
                                        <tr height="30px !important;">
                                            <td class="bg-secondary text-white">Jurusan / Prodi</td>
                                            <td> {{ $userDetail->jurusan == '' ? 'belum diisi' : $userDetail->jurusan }}
                                            </td>
                                        </tr>
                                        <tr height="30px !important;">
