...
@section('title', 'UserDetail Lists')
@push('plugin-styles')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <a href="{{ route('userDetails.create') }}" class="btn btn-ico btn-success" title="Create New User">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            table.on('click', '.edit', function() {
                ...
                var url = "{{ url('/userDetails') }}" + '/' + uuid + '/edit/';
                window.open(url, "_self")
            });

            table.on('click', '.show', function() {
                var uuid = $(this).data("id");
                var url = "{{ url('/userDetails') }}" + '/' + '' + uuid;
                window.open(url, "_self")
            });
