...
@section('content')
    <div>
        <h4 class="mb-3 mb-md-0">Application Edit</h4>
    </div>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
<form method="POST" action="{{ route('applications.update', $application->uuid) }}" id="edit_application_form" name="edit_application_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
